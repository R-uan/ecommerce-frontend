	...
	return (
		<Link className="w-fit h-fit" href={`/catalog/${data.id}`}>
			<div className="flex flex-col w-[15vw] rounded-md min-h-[22.5vw] h-fit text-all-white">
				<div className="relative w-[15vw] h-[15vw] overflow-hidden justify-center rounded-[5px]">
				...
				<div className="flex flex-col items-center justify-between h-[clamp(70px,5.5vw,5.5vw)] m-0.5 p-[5px] rounded-[0px_0px_5px_5px]">
					<div className="gap-[5px] w-[260px] flex items-center flex-col">
						<h3 className="text-[clamp(1rem,1.25vw,1.25vw)] w-full break-words text-center leading-[clamp(1rem,1.25vw,1.25vw)] font-kode font-bold">{data.name}</h3>
